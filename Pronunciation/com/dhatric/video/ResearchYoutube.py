...
def update_video_thumbnail(youtube,videoID):
    results = youtube.videos().list(part="snippet",id=videoID).execute()
    print "yoyo"
...
if __name__ == '__main__':
    ...
    try:
        ...
        thumbnails_set(youtube,"Aug.jpeg",videoId=videoId)
    except HttpError, e:
