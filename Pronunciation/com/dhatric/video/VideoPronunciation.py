...
def createVideo(wordObject):
    ...
    txt_word = TextClip(wordObject.get_word(),fontsize=80,color='white',font='Algerian')
    txt_word = txt_word.set_pos('center').set_duration(audio_file.duration)
    txt_phonetic = TextClip(wordObject.get_phonetic(),fontsize=40,color='white',font='Algerian')
